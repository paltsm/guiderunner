...
(8, 'Counter-Strike: Global Offensive', 'Operation Shattered Web', 'Introducing Operation Shattered Web. For the first time in CS:GO, bring your favorite character into battle with all-new equippable agents. Earn rewards featuring the new agents, all-new weapon collections, stickers, graffiti, and more through a new battle pass format. Complete weekly Operation Missions in various game modes including Co-op Guardian and a new Co-op Strike Mission!', 'https://store.steampowered.com/news/app/730/view/1604899184801773232', '2019-10-19'),
